...
namespace SM5002TestTool
{
    class hfReaderDll
    { 
        public const Byte UART_FRAME_CMD_PLANE_BAT = 0x36;
        public const Byte UART_FRAME_CMD_GET_ININFO = 0x37;
        public const Byte UART_FRAME_CMD_SET_OUTINFO = 0x38;
        public const Byte UART_FRAME_CMD_CHARGE = 0x39;
        public const Byte UART_FRAME_CMD_RTNBAT = 0x3A;
        public const Byte UART_FRAME_CMD_BRWBAT = 0x3B;
        public const Byte UART_FRAME_CMD_SET_PARAMS = 0x3C;
        public const Byte UART_FRAME_CMD_GET_PARAMS = 0x3D;
...
//         public const Byte HFREADER_TIMEOUT = 200;
        ...
        [DllImport("HFReader.dll", EntryPoint = "hfReaderFormatFrame")]
        public static extern int hfReaderFormatFrame(ushort srcAddr, ushort targetAddr, Byte cmd, Byte rspFrame, Byte longFrame, Byte[] pParam, int len, Byte[] pFrame);

        [DllImport("HFReader.dll", EntryPoint = "hfReaderTransFrame")]
        public static extern int hfReaderTransFrame(int h, Byte[] pBuffer, uint len);
